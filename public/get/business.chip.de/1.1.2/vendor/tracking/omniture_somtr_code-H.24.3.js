define(function() {
    ...
    return function(s_account) {
        /* SiteCatalyst code version: H.24.3.
         Copyright 1996-2012 Adobe, Inc. All Rights Reserved
         More info available at http://www.omniture.com */

        var s_account = s_account || "chipdedesign"
        ...
        s.linkInternalFilters = "javascript:,chip.eu,chip.de,xonio.com"
        ...
        s.visitorNamespace = "chipxonioonlinegmbh"
        s.trackingServer = "omniture.chip.de"
        ...
        s.Media.trackMilestones = "5,25,50,75"; //or Media.trackSeconds        
        s.Media.segmentByMilestones = true;
        //s.Media.trackWhilePlaying = true;
        s.Media.completeByCloseOffset = false;
        s.Media.trackUsingContextData = true;
        s.Media.trackVars = "events,eVar1,eVar2,eVar3,prop2";
        s.Media.trackEvents = "event1,event2,event3,event4,event5,event6,event7,event9";
